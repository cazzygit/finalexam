    ...
    <div class="card-body">
        <ul class="detail-list">
            <li>
                ...
                <span>{{ $section->college->name }}</span>
            </li>
            <li>
...
@if($section->students->count() > 0)
    ...
    <div class="card-header" style="display:flex; align-items:center; justify-content:space-between; gap:1rem; flex-wrap:wrap;">
        ...
        <a href="{{ route('students.create', ['college_id' => $section->college_id, 'section_id' => $section->id, 'from_section' => '1']) }}" class="btn btn-primary">
            Add Student
        </a>
    </div>
        <div class="card-body">
                    ...
                    <tbody>
                        @foreach($section->students as $student)
                            <tr>
                                ...
                                <td>{{ $student->fname }} {{ $student->mi }} {{ $student->lname }}</td>
                                <td>
...
@else
    <div class="empty-state" style="margin-top: 2rem;">
        ...
        <a href="{{ route('students.create', ['college_id' => $section->college_id, 'section_id' => $section->id]) }}" class="btn btn-primary">
            Add New Student
        </a>
    </div>
@endif
